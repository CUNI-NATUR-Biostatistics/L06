...
| 2026-08-06 | Stage 2 | in review | Completed a callback-rich Palmer penguin lesson linking categorical `lm()`, within-group variability, two-group inference, overall analysis of variance, and pairwise follow-ups | `Workflow/records/2026-08-06-stage-2-learning-materials.md` | `lesson/l06-skripta` / not opened | Internal reviews complete; awaiting Ondřej Mottl |
