...
| 2026-08-10 | Stage 3 | done | Human review completed after ten feedback batches and final PDF-composition, glossary, warning, whitespace, and reproducibility fixes; the approved 47-page written materials retain the regression-to-categorical-model arc, overall-test-before-post-hoc sequence, and namespaced `emmeans` workflow | `Workflow/records/2026-08-06-stage-2-learning-materials.md` | `lesson/l06-skripta` / not opened | Ondřej Mottl approved |
